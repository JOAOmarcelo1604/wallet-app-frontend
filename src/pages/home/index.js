...
const onDeleteItem = async (id) => {
  try {
    ...
    await fetch(
      `https://wallet-app-xrbik1pdd-joao-marcelos-projects-89356393.vercel.app/finances/${id}`,
      {
        method: "DELETE",
        mode: "cors",
        cache: "no-cache",
...
const onLoadFinancesData = async () => {
  try {
    ...
    const result = await fetch(
      `https://wallet-app-xrbik1pdd-joao-marcelos-projects-89356393.vercel.app/finances?date=${dateInputValue}`,
      {
        method: "GET",
        headers: {
          email: email,
...
const onLoadCategories = async () => {
  try {
    ...
    const response = await fetch(
      "https://wallet-app-xrbik1pdd-joao-marcelos-projects-89356393.vercel.app/categories"
    );
